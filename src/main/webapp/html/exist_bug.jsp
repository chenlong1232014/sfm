	...
	<form class="form-horizontal" onsubmit="return false" id="myForm" method="post" action="##" method="post" role="form">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-6">
				<label for="" class="col-sm-2 control-label"> 测试结果 </label> <label
					class="radio-inline"> <input type="radio" name="result"
					id="" value="1"> 存在 </label> <label class="radio-inline"> <input
					type="radio" name="result" id="" value="0"> 不存在 </label>
			</div>
		</div>
		<div class="form-group">
			<label for="desc" class="col-sm-3 control-label">确认描述</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<div class="col-sm-offset-8 col-sm-8">
				<button onclick="existBug();" class="btn btn-success btn-lg">提交</button>
			</div>
		</div>
	</form>
</body>
