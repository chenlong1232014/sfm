							...
							columns : [
									...
									},
									{
										...
										formatter : function(value, row, index) {//自定义显示可以写标签哦~ 
											if (row.passed) {
												return '<span class="glyphicon glyphicon-ok" style="color: rgb(0, 207, 0); font-size: 17px;"></span>';
											}

											else {
												return '<span class="glyphicon glyphicon-remove" style="color: rgb(211, 0, 0); font-size: 17px;"></span>';
											}
										}
									},
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" id="logForm" role="form">
						<div class="form-group">
							<input type="hidden" name="plid" id="plid">
						</div>
						<div class="form-group">
							<label for="name" class="col-sm-2 control-label">处理过程描述</label>
							<div class="col-sm-9">
								<textarea  id="logDesc" name="logDesc"
									class="form-control well"></textarea>
							</div>
						</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" onclick="uptLog()">保存</button>
				</div>
			</div>
		</div>
	</div>
