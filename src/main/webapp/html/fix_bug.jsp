	...
	<form class="form-horizontal" onsubmit="return false" id="myForm" method="post" action="##" method="post" role="form">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-6">
				<label for="" class="col-sm-2 control-label"> 修复结果 </label> <label
					class="radio-inline"> <input type="radio" name="result"
					id="" value="1"> 可以修复 </label> <label class="radio-inline">
					<input type="radio" name="result" id="" value="0"> 无法修复 </label>
			</div>
		</div>
		<div class="form-group">
			<label for="fixDesc" class="col-sm-3 control-label">修复过程描述</label>
			<div class="col-sm-6">
				<textarea name="fixDesc" id="fixDesc" class="form-control" rows="5"></textarea>
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-offset-8 col-sm-8">
				<button onclick="fixBug();" class="btn btn-success btn-lg">提交</button>
			</div>
		</div>
	</form>
</body>
