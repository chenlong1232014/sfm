...
<title>My JSP 'assign_bug.jsp' starting page</title>
...
<body>
	<form class="form-horizontal" onsubmit="return false" id="myForm" method="post" action="##" method="post" role="form">
		...
		<div class="form-group">
			<label for="uid" class="col-sm-3 control-label">修复人员 </label>
			<div class="col-sm-6">
				<select name="uid" id="uid"
					class="selectpicker show-tick form-control" data-width="98%"
					data-first-option="false" title='请选择修复人员(必选)' required
					data-live-search="true">
		...
		<div class="form-group">
			<label for="desc" class="col-sm-3 control-label">分配描述</label>
			<div class="col-sm-6">
		...
		<div class="form-group">
			<div class="col-sm-offset-8 col-sm-8">
				<button onclick="assignBug();" class="btn btn-success btn-lg">提交</button>
			</div>
		</div>
	</form>
</body>
